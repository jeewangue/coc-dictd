...
var setExtConfig = (c) => {
  ...
  extConfig.translate.formality = c.get("translate.formality", "none");
  extConfig.translate.sourceLanguageCode = c.get("translate.sourceLanguageCode", "auto");
  extConfig.translate.targetLanguageCode = c.get("translate.targetLanguageCode", "en");
};
...
async function activate(context) {
  ...
  {
    const c = import_coc15.workspace.getConfiguration("coc-dictd");
    setExtConfig(c);
  }
